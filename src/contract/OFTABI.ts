export const OMNIContractAddress = "0x9e20461bc2c4c980f62f1B279D71734207a6A356";

export const OFTContractABI = [
  {
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_maxHolding", type: "uint256" },
    ],
    name: "firstMeow",
    outputs: [],
    stateMutability: "nonpayable",
